...
<html>
   ...
   <body>
      <h3>Enter Your details customer</h3>
   ...
   Email:<c:out value="${userInfo.email}"/><br>
   Gender(M/F):<jsp:getProperty name="userInfo" property="gender"/><br>
   </body>

   <c:if test="${userInfo.userNameIsValid && userInfo.birthDateIsValid && userInfo.emailIsValid && param.submitted }">
